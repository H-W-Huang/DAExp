...
if __name__ == '__main__':
    ...
    source_loader, source_test_loader = get_extra_dataloader_cifar(args.batchsize,resize_224=True)
        # source_loader, source_test_loader = get_extra_dataloader_cifar(args.batchsize, resize_224=False)
    target_train_loader, target_test_loader = get_target_dataloader_cifar(args.batchsize,resize_224=True)
