...
def get_shadow_dataloader_cifar(batch_size, data_root='../dataset',resize_224=False,**kwargs):
    num_workers = kwargs.setdefault('num_workers', 1)
    kwargs.pop('input_size', None)
...
def get_target_dataloader_cifar(batch_size, data_root='../dataset',resize_224=False,**kwargs):
    num_workers = kwargs.setdefault('num_workers', 1)
    kwargs.pop('input_size', None)
    print("Building CIFAR100 data loader with {} workers".format(num_workers))
    if resize_224:
...
def get_extra_dataloader_cifar(batch_size, data_root='../dataset', resize_224=False, **kwargs):
    num_workers = kwargs.setdefault('num_workers', 1)
    kwargs.pop('input_size', None)
    print("Building CIFAR100 data loader with {} workers".format(num_workers))
...
def get_extra_dataloader_cifar_2(batch_size, data_root='../dataset', resize_224=False, **kwargs):
    num_workers = kwargs.setdefault('num_workers', 1)
    kwargs.pop('input_size', None)
    print("Building CIFAR100 data loader with {} workers".format(num_workers))
...
def get_outer_extra_dataloader_cifar(batch_size, data_root='../dataset', resize_224=False, **kwargs):
    num_workers = kwargs.setdefault('num_workers', 1)
    kwargs.pop('input_size', None)
    print("Building CIFAR100 data loader with {} workers".format(num_workers))
