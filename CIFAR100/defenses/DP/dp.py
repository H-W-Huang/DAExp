...
def main():
    ...
    print("The training takes %s"%(str(time_cost)))
    if save_model:
...
if __name__ == "__main__":
    ...
    epoch = 100
    train_loader, test_loader = get_target_dataloader_cifar(BATCH_SIZE)
    model = torch.load("dp_cifar100_%d.pt"%epoch)
    ...
    import pickle
    pickle.dump(member_socres, open("cifar100_target_member_socres_%d.pkl"%epoch,"wb"))
    pickle.dump(non_member_socres, open("cifar100_target_non_member_socres_%d.pkl"%epoch,"wb"))
