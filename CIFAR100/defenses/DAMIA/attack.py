...
def run():
    ...
    with open("cifar_damia_95.pt","rb") as f:
        model = torch.load(f)
    ...
    mia_attacker.perfrom_attack("cifar100_target_member_socres_target.pkl", "cifar100_target_non_member_socres_target.pkl")
    print("MIA Acc on source domain:")
    mia_attacker.perfrom_attack("cifar100_target_member_socres_source.pkl", "cifar100_target_non_member_socres_source.pkl")
