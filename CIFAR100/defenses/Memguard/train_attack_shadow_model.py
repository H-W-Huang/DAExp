...
# (x_train,y_train),(x_test,y_test) = input_data_.input_data_attacker_shallow_model_adv1()
(x_train,y_train),(x_test,y_test) = input_data_class.input_data_attacker_shallow_model_adv1_location()
