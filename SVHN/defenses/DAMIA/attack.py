...
def run():
    ...
    mia_attacker.perform_threshold_attack(
            "svhn_target_member_socres_target.pkl", 
            "svhn_target_non_member_socres_target.pkl", 
            "svhn_target_member_label_target.pkl", 
            "svhn_target_non_member_label_target.pkl", 
            )
