...
import os
import sys
sys.path.append("/home/user01/exps/DAMIA/Second_stage/defenses")
...
def load_victim_model_dataset_location():
...
def load_defender_model_dataset_location():
    x_data,y_data = load_location()
    x_data_victim, y_data_victim = slice_dataset(x_data,y_data,0,1500) 
    n = len(x_data_victim)
...
def load_attacker_evaluate_location():
    x_data,y_data = load_location()
...
def input_data_attacker_adv1_location():
...
def input_data_attacker_shallow_model_adv1_location():
