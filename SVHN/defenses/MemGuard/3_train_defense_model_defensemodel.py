...
f_train = np.concatenate((member_scores[:5000],non_member_scores[:5000]),axis=0)
y_train = np.concatenate((y_train[:5000],y_test[:5000]),axis=0)
...
# f_train = np.concatenate(member_scores[:5000])
# del model
